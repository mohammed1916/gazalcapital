        ...
        <div id="#Brand">
            <Box
                ...
                <Container sx={{ width: '100%' }}>
                    <Box className="rounded-2xl" display={'flex'} flexDirection={'column'} flexWrap={'wrap'} alignItems={'center'} justifyContent='center' margin={'10px'} marginTop={'50px'} boxShadow={'0px 2px 30px #c30164,0px 5px 10px rgba(0,0,0)'} padding={{ xs: 1, sm: 2 }} bgcolor={'black'}>
