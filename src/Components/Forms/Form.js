    ...
    return (
        <div id="#Form">
            <Container sx={{ width: '100%' }}>
                <Box className="rounded-2xl" display={'flex'} flexDirection={'column'} flexWrap={'wrap'} alignItems={'center'} justifyContent='center' marginTop={'35px'} boxShadow={5} padding={"0.3rem"} paddingTop={'0.7rem'} marginBottom={'2rem'} bgcolor={'white'}>
                    <div >
                                    ...
                                    <div className="w-full px-3 sm:w-1/2">
                                        <div className="mb-5">
                                            ...
                                            <input
                                                ...
                                                className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-2 text-base font-medium text-[#6B7280] outline-none focus:border-b-yellow-500 focus:border-[#ce9f13] focus:shadow-md"
                                                onChange={(data) => {
